...
@dataclass
class LabelSmoothedCrossEntropyWithRetrievalLossCriterionConfig(FairseqDataclass):
    retrieval_loss_ratio: float = field(
        default=0.1,
        metadata={"help": "retrieval loss ratio"},
    )
...
@register_criterion(
    "label_smoothed_cross_entropy_with_retrieval_loss", dataclass=LabelSmoothedCrossEntropyWithRetrievalLossCriterionConfig
)
class LabelSmoothedCrossEntropyWithRetrievalLossCriterion(FairseqCriterion):
    def __init__(
        self,
        task,
        sentence_avg,
        ...
        self.retrieval_loss_ratio = retrieval_loss_ratio
    ...
    def compute_loss(self, model, net_output, sample, reduce=True):
        ...
        loss = loss + self.retrieval_loss_ratio * retrieval_loss
