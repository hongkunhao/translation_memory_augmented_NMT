...
from fairseq.models.transformer.transformer_base_with_TM import (
    TransformerModelBaseWithTM,
)


@register_model("transformer_with_TM")
class TransformerModelWithTM(TransformerModelBaseWithTM):
    """
...
@register_model_architecture("transformer_with_TM", "transformer_with_TM")
def base_architecture(args):
    args.memory_encoder_layers = getattr(args, "memory_encoder_layers", 4)
...
@register_model_architecture("transformer_with_TM", "transformer_wmt_en_de_with_TM")
def transformer_wmt_en_de_with_TM(args):
    base_architecture(args)
